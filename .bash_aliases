...
alias gbn='f() { git switch $1 2>/dev/null || git switch -c $1; unset -f f; }; f' # Git 2.23
...
alias k8c='k8 config'
alias k8cv='k8c view'
alias k8d='k8 describe'
alias k8g='k8 get --all-namespaces'
alias k8gd='k8g deploy,svc,pods,pvc,rc,rs'
alias k8l='k8 logs --all-containers'
alias k8t='k8l --tail=1 -f'
alias k8r='k8 delete -f'
alias k8rp='k8r --grace-period=1 po'
alias k8s='k8 config use-context'
alias k8x='k8 exec -it'
alias kc='kompose'
