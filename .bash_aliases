...
alias dkup='f(){ dockerfile=${1:-Dockerfile}; docker run -it "$(dkb build -q -f $dockerfile .) $2"; unset -f f; }; f'
alias dkup1='f(){ dockerfile=${1:-Dockerfile}; docker run -it --rm "$(dkb build -q -f $dockerfile .) $2"; unset -f f; }; f'
