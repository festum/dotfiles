...
alias dkrun='f(){ dockerfile=${1:-Dockerfile}; docker run -it "$(dkb build -q -f $dockerfile .) $2"; unset -f f; }; f'
alias dkrun1='f(){ dockerfile=${1:-Dockerfile}; docker run -it --rm "$(dkb build -q -f $dockerfile .) $2"; unset -f f; }; f'
